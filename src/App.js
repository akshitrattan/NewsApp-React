  ...
  render() {
    return (
      <Router>
        ...
        <Routes>
          <Route exact path="/" element={<News key="Home" category="none"/>}></Route>
          ...
          <Route exact path="/Food" element={<News key="general" category="general"/>}></Route> 
          <Route exact path="/Health" element={<News key="health" category="health"/>}></Route> 
          <Route exact path="/Politics" element={<News key="science" category="science"/>}></Route> 
